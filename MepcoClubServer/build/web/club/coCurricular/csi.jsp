...
<html>
    <head>
        ...
        <link rel="icon" href="../../img/coCurricular/csi.png">
    </head>
    <body>
        <nav class="navbar navbar-expand-sm bg-secondary" id="navBar">
            <div class="container">
               <ul class="navbar-nav">
                ...
                <div>
                    <img src="../../img/coCurricular/csi.png" alt="not available" width="50" height="50" class="img-thumbnail">
                </div>
            </div>
        </nav>
        <section class="testimonials text-center bg-light" id="about">
            <div class="container">
              <h2 class="mb-5" >About Us</h2>
               <div class="row">
                       <p>
                        Computer Society of India club is excellent Platform to develop communication skills, soft skills,
        ...
        <table class="table table-hover" style="text-align: center">
            ...
            <%
                ...
                String sql = "select Date, eventname from event where club='csi' order by Date desc;";
