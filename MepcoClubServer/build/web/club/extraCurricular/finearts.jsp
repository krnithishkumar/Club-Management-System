...
<html>
    <head>
        ...
        <title>finearts Club</title>
        <link rel="stylesheet" href="../../css/bootstrap.css">
        <link rel="stylesheet" href="../../css/style.css">
        <link rel="icon" href="../../img/extraCurricular/fine_arts.png">
    </head>
    <body>
        <nav class="navbar navbar-expand-sm bg-secondary" id="navBar">
            <div class="container">
               <ul class="navbar-nav">
                ...
                <div>
                    <img src="../../img/extraCurricular/fine_arts.png" alt="not available" width="50" height="50" class="img-thumbnail">
                </div>
            </div>
        </nav>
        <section class="testimonials text-center bg-light" id="about">
            <div class="container">
              <h2 class="mb-5" >About Us</h2>
               <div class="row">
                       <p>
                        Fine Arts club is excellent Platform to develop communication skills, soft skills,
        ...
        <table class="table table-hover" style="text-align: center">
            ...
            <%
                ...
                String sql = "select Date, eventname from event where club='finearts' order by Date desc;";
