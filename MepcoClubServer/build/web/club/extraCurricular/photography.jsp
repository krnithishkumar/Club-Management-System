    ...
    <body>
        <nav class="navbar navbar-expand-sm bg-secondary" id="navBar">
            <div class="container">
               <ul class="navbar-nav">
                ...
                <div>
                    <img src="../../img/extraCurricular/photography.png" alt="not available" width="50" height="50" class="img-thumbnail">
                </div>
            </div>
        </nav>
        <section class="testimonials text-center bg-light" id="about">
            <div class="container">
              <h2 class="mb-5" >About Us</h2>
               <div class="row">
                       <p>
                        Photography club is excellent Platform to develop communication skills, soft skills,
        ...
        <table class="table table-hover" style="text-align: center">
            ...
            <%
                ...
                String sql = "select Date, eventname from event where club='photography' order by Date desc;";
